...
data = {
    ...
    "entries": [
        ...
        {
            "API": "The Dog",
            "Description": "A public service all about Dogs, "
                           "free to use when making your fancy new App, Website or Service",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "no",
        ...
        {
            "API": "SAWO Labs",
            "Description": "Simplify login and improve user experience by "
                           "integrating passwordless authentication in your app",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Helium",
            "Description": "Helium is a global, distributed network of Hotspots that create public, "
        ...
        {
            "API": "Bhagavad Gita",
            "Description": "Open Source Shrimad Bhagavad Gita API "
                           "including 21+ authors translation in Sanskrit/English/Hindi",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Ganjoor",
            "Description": "Classic Persian poetry works including access to related manuscripts, "
                           "recitations and music tracks",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "SwiftKanban",
            "Description": "Kanban software, Visualize Work, Increase Organizations Lead Time, "
                           "Throughput & Productivity",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
            "Link": "https://www.digite.com/knowledge-base/swiftkanban/"
                    "article/api-for-swift-kanban-web-services/#restapi",
            "Category": "Business"
        },
        {
        ...
        },
        {
            ...
            "Description": "Industry-leading Holiday API. Over 5,000 holidays and thousands of descriptions. "
        ...
        {
            "API": "Non-Working Days",
            "Description": "Simple REST API for checking working, non-working or short days for Russia, "
                           "CIS, USA and other",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "CircleCI",
            "Description": "Automate the software development process using "
        ...
        {
            "API": "Ethplorer",
            "Description": "Ethereum tokens, balances, addresses, history of transactions, contracts, "
        ...
        },
        {
            ...
            "Description": "Exchange rates between 162 currency & 300 crypto currency update each 5 min, "
                           "accurate, no limits",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Get IP Address, Timestamp, User Agent, Country Code, IATA, "
                           "HTTP Version, TLS/SSL Version & More",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Heroku",
            "Description": "REST API to programmatically create apps, "
                           "provision add-ons and perform other task on Heroku",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "ipfind.io",
            "Description": "Geographic location of an IP address or any domain name "
        ...
        {
            "API": "JSON 2 JSONP",
            "Description": "Convert JSON to JSONP (on-the-fly) for easy cross-domain "
                           "data requests using client-side JavaScript",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "oyyi",
            "Description": "API for Fake Data, image/video conversion, optimization, "
                           "pdf optimization and thumbnail generation",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "HTTPS": True,
            "Cors": "unknown",
            "Link": "https://www.postman.com/postman/workspace/postman-public-workspace/"
                    "documentation/12959542-c8142d51-e97c-46b6-bd77-52bb66712c9a",
            "Category": "Development"
        },
        {
            "API": "ProxyCrawl",
        ...
        {
            "API": "ZenRows",
            "Description": "Web Scraping API that bypasses anti-bot solutions while offering JS rendering, "
        ...
        {
            "API": "Clockify",
            "Description": "Clockify's REST-based API can be used to push/pull data to/from "
                           "it & integrate it with other systems",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "CloudConvert",
            "Description": "Online file converter for audio, video, document, ebook, archive, "
                           "image, spreadsheet, presentation",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "iLovePDF",
            "Description": "Convert, merge, split, extract text and add page numbers for PDFs. "
                           "Free for 250 documents/month",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "JIRA",
            "Description": "JIRA is a proprietary issue tracking product that allows "
        ...
        },
        {
            ...
            "Description": "Performs image upscaling by adding detail to images through "
        ...
        {
            "API": "Mailtrap",
            "Description": "A service for the safe testing of emails sent from the "
        ...
        {
            "API": "Sendgrid",
            "Description": "A cloud-based SMTP provider that allows you to send "
                           "emails without having to maintain email servers",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Sendinblue",
            "Description": "A service that provides solutions relating to "
                           "marketing and/or transactional email and/or SMS",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Climatiq",
            "Description": "Calculate the environmental footprint created by a "
                           "broad range of emission-generating activities",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Finage",
            "Description": "Finage is a stock, currency, cryptocurrency, "
                           "indices, and ETFs real-time & historical data provider",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Yahoo Finance",
            "Description": "Real time low latency Yahoo Finance API for stock market, "
                           "crypto currencies, and currency exchange",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Includes all monsters and spells from the SRD (System Reference Document) "
                           "as well as a search API",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Raider",
            "Description": "Provides detailed character and guild rankings for "
                           "Raiding and Mythic+ content in World of Warcraft",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "BigDataCloud",
            "Description": "Provides fast and accurate IP geolocation APIs "
                           "along with security checks and confidence area",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "bng2latlong",
            "Description": "Convert British OSGB36 easting and northing (British National Grid) "
        ...
        {
            "API": "Cep.la",
            "Description": "Brazil RESTful API to find information about streets, zip codes, "
        ...
        },
        {
            ...
            "Description": "World countries, states, regions, provinces, "
                           "cities & towns in JSON, SQL, XML, YAML, & CSV format",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Graph Countries",
            "Description": "Country-related data like currencies, languages, flags, "
                           "regions+subregions and bordering countries",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Ip to location with country code, currency code & currency name, "
                           "fast response, unlimited requests",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "IPInfoDB",
            "Description": "Free Geolocation tools and APIs for country, region, "
                           "city and time zone lookup by IP address",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Get the IP geolocation data through the simple REST API. "
        ...
        },
        {
            ...
            "HTTPS": False,
            "Cors": "unknown",
            "Link": "http://api.postcodedata.nl/v1/postcode/"
                    "?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json",
            "Category": "Geocoding"
        },
        {
            "API": "Postcodes.io",
        ...
        },
        {
            ...
            "Description": "Provides legislative information in Apis XML and JSON, "
                           "as well as files in various formats",
            "Auth": "",
            "HTTPS": True,
            "Cors": "no",
        ...
        },
        {
            ...
            "Description": "Contains live datasets including information about petitions, "
                           "bills, MP votes, attendance and more",
            "Auth": "",
            "HTTPS": False,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "This API provides read access to DIP entities "
                           "(e.g. activities, persons, printed material)",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Contains D.C. government public datasets, "
                           "including crime, GIS, financial data, and so on",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Basic candidate data and live electoral vote "
                           "counts for top two parties in US presidential election",
            "Auth": "",
            "HTTPS": True,
            "Cors": "no",
        ...
        },
        {
            ...
            "HTTPS": True,
            "Cors": "unknown",
            "Link": "https://pipedream.com/@pravin/"
                    "http-api-for-latest-wuhan-coronavirus-data-2019-ncov-p_G6CLVM/readme",
            "Category": "Health"
        },
        {
        ...
        {
            "API": "Covid-19 India",
            "Description": "Covid 19 statistics state and district "
                           "wise about cases, vaccinations, recovery within India",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Global and countrywise data of Covid 19 daily "
                           "Summary, confirmed cases, recovered and deaths",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Humanitarian Data Exchange (HDX) is open "
        ...
        {
            "API": "Lexigram",
            "Description": "NLP that extracts mentions of clinical "
                           "concepts from text, gives access to clinical ontology",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "National Plan & Provider Enumeration System, "
                           "info on healthcare providers registered in US",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Orion Health",
            "Description": "Medical platform which allows the development"
                           " of applications for different healthcare scenarios",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Hirak FaceAPI",
            "Description": "Face detection, face recognition with age "
                           "estimation/gender estimation, accurate, no quota limits",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "NLP Cloud",
            "Description": "NLP API using spaCy and transformers for NER, "
                           "sentiments, classification, summarization, and more",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "SoundCloud",
            "Description": "With SoundCloud API you can build applications that "
                           "will give more power to control your content",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Provides access to millions of pages of historic "
                           "US newspapers from the Library of Congress",
            "Auth": "",
            "HTTPS": False,
            "Cors": "unknown",
        ...
        {
            "API": "Trove",
            "Description": "Search through the National Library of Australia "
                           "collection of 1000s of digitised newspapers",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "API Setu",
            "Description": "An Indian Government platform that provides "
                           "a lot of APIS for KYC, business, education & employment",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "LinkPreview",
            "Description": "Get JSON formatted summary with title, "
                           "description and preview image for any requested URL",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Recreational areas, federal lands, historic sites, "
                           "museums, and other attractions/resources(US)",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Courses, lecture videos, detailed information for "
                           "courses etc. for the University of Oslo (Norway)",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Metabase",
            "Description": "An open source Business Intelligence server "
                           "to share data and analytics inside your company",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "PatentsView ",
            "Description": "API is intended to explore and visualize "
                           "trends/patterns across the US innovation landscape",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "arXiv",
            "Description": "Curated research-sharing platform: physics, "
                           "mathematics, quantitative finance, and economics",
            "Auth": "",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Numbers",
            "Description": "Number of the day, random number, "
                           "number facts and anything else you want to do with numbers",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "no",
        ...
        },
        {
            ...
            "Description": "Android library and API to verify the safety of user devices, "
                           "detect rooted devices and other risks",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "HackerOne",
            "Description": "The industry\u2019s first hacker API that helps "
                           "increase productivity towards creative bug bounty hunting",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Privacy.com",
            "Description": "Generate merchant-specific and one-time "
                           "use credit card numbers that link back to your bank",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Spyse",
            "Description": "Access data on all Internet assets "
                           "and build powerful attack surface management applications",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "WooCommerce",
            "Description": "WooCommerce REST APIS to create, read, update, "
                           "and delete data on wordpress website in JSON format",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "Foursquare",
            "Description": "Interact with Foursquare users and places "
                           "(geolocation-based checkins, photos, tips, events, etc)",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Cloudbet",
            "Description": "Official Cloudbet API provides real-time sports "
                           "odds and betting API to place bets programmatically",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Embed codes for goals and highlights from "
                           "Premier League, Bundesliga, Serie A and many more",
            "Auth": "",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Football score/schedule, news api, tv channels, "
                           "stats, history, display standing e.g. epl, la liga",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        },
        {
            ...
            "Description": "Natural language understanding technology, "
                           "including sentiment, entity and syntax analysis",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Hirak OCR",
            "Description": "Image to text -text recognition- from image more "
                           "than 100 language, accurate, unlimited requests",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "unknown",
        ...
        {
            "API": "Tisane",
            "Description": "Text Analytics with focus on detection of "
                           "abusive content and law enforcement applications",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "WeCanTrack",
            "Description": "Automatically place subids in affiliate links "
                           "to attribute affiliate conversions to click data",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "yes",
        ...
        },
        {
            ...
            "Description": "Provides safe restroom access for transgender, "
        ...
        },
        {
            ...
            "HTTPS": True,
            "Cors": "unknown",
            "Link": "https://data.renfe.com/api/1/util/snippet/api_"
                    "info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a",
            "Category": "Transportation"
        },
        {
        ...
        },
        {
            ...
            "Description": "Vehicles information from Funda\u00e7\u00e3o "
        ...
        {
            "API": "Mercedes-Benz",
            "Description": "Telematics data, remotely access vehicle functions, "
                           "car configurator, locate service dealers",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "no",
        ...
        {
            "API": "Smartcar",
            "Description": "Lock and unlock vehicles and get data like odometer "
                           "reading and location. Works on most new cars",
            "Auth": "OAuth",
            "HTTPS": True,
            "Cors": "yes",
        ...
        {
            "API": "JSON2Video",
            "Description": "Create and edit videos programmatically: "
                           "watermarks,resizing,slideshows,voice-over,text animations",
            "Auth": "apiKey",
            "HTTPS": True,
            "Cors": "no",
...
#     if elem["Category"] in category_list:
#         continue
#     else:
#         category_list.append(elem["Category"])
# pprint(category_list)

for elem in data["entries"]:
    if elem["Category"] == 'News':
        my_list.append(elem)
